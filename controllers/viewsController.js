...
exports.alerts = (req, res, next) => {
    ...
    if (alert === 'booking') {
        res.locals.alert = 'Your booking was successful, please check your email for a confirmation. If your booking does not show here immediately, please come back later'
    };
