...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51POfurAXhqp78HHEPuL5ulNwLlSuPx5z2RjBax6a9NUiDsHQjVJP5TeZTYQsBJ3xEDjpg0uooUau7HavU3wApmrg00P1nmopBT'); // this key is the public key from the stripe api (script in base.pug)
...
var userDataForm = document.querySelector('.form-update-user');
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            confirmPassword = document.getElementById('password-confirm').value; // waiting for this function to finish so we can clear the password form after completion
            _context.next = 7;
